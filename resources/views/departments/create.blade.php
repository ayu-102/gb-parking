<x-app-layout>
    <div class="max-w-xl mx-auto space-y-6">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-slate-800 tracking-tight">Tambah Departemen Baru</h1>
                <p class="text-xs text-slate-500 mt-1">Masukkan informasi divisi/departemen baru di GB Parking.</p>
            </div>
